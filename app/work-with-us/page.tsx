    ...
    <main className="flex min-h-screen flex-col items-center bg-[#1A1A1A]">
      ...
      <section className="w-full py-8 sm:py-12 md:py-16 bg-[#1A1A1A] flex flex-col items-center">
        <div className="container px-3 sm:px-4 md:px-6 max-w-4xl">
          <ScrollAnimation className="flex justify-center mb-8">
            ...
            {formSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-300 mb-6 max-w-md mx-auto">
                  Thank you for your interest in joining the Momo Kato family.
                  Our HR team will review your application and get back to you
                  soon.
                </p>
                <Button
                  className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-black font-bold rounded-lg px-6 py-2 sm:px-8 sm:py-3 btn-animate"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="w-full bg-transparent border-2 border-gray-600 text-white rounded-lg py-2 px-3 sm:py-3 sm:px-4 flex items-center justify-between hover:border-orange-600 transition-colors">
                      <span
                        className={
                          selectedFile ? "text-white" : "text-gray-400"
                        }
                      >
                        {selectedFile
                          ? selectedFile.name
                ...
                <div className="pt-4">
                  <Button
                    type="submit"
                    className="w-auto bg-transparent border-2 border-white text-white hover:bg-white hover:text-black font-bold rounded-lg px-6 py-2 sm:px-8 sm:py-3 mx-auto block transition-all duration-300 leading-none btn-animate"
                  >
                    APPLY NOW
                  </Button>
                </div>
      ...
      <section className="w-full py-8 sm:py-12 md:py-16 bg-[#1A1A1A] border-t border-gray-800">
        <div className="container px-3 sm:px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto stagger-children">
            ...
            <ScrollAnimation
              delay={100}
              className="bg-[#2A2A2A] rounded-xl p-4 sm:p-6 md:p-8 text-center hover:bg-[#333333] transition-colors duration-300 card-hover"
            >
              ...
              <Link href="/franchise">
                <Button className="bg-transparent border-2 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white font-bold rounded-lg px-4 py-1.5 sm:px-6 sm:py-2 text-sm sm:text-base transition-all duration-300 btn-animate">
                  Learn More
                </Button>
              </Link>
            </ScrollAnimation>
            ...
            >
              ...
              <Link href="/find-us">
                <Button className="bg-transparent border-2 border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white font-bold rounded-lg px-4 py-1.5 sm:px-6 sm:py-2 text-sm sm:text-base transition-all duration-300 btn-animate">
                  Find a Store
                </Button>
              </Link>
            </ScrollAnimation>
